...
#     url = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol={stockname}&interval=1&apikey={api_key}'
...
#         return jsonify(data)
#     else:
#         return jsonify({"error": "Invalid API key or stock name."})
...
#     url = f'https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol={stockname}&apikey={api_key}'
...
#             return render_template('result.html', stockname=stockname, symbol=symbol, time_series_data=time_series_data)
#         else:
...
#             return render_template('result.html', stockname=stockname, time_series_data=time_series_data)
#         else:
#             return jsonify({"error": "No data found for the given stock."})
#     else:
#         return jsonify({"error": "Invalid API key or stock name."})
...
#daily 
#https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AMZN&outputsize=full&apikey=8KO6U7YFARRYWCP7
